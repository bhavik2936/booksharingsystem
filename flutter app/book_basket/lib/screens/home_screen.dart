...
class _HomeScreenState extends State<HomeScreen> {
  ...
  List<String> genreList = ['Latest Arrivals', 'Nearby Books'];

  Future<void> fetchLatestBooks() async {
    try {
      var response = await Requests.post(
          'http://yoururl/booksharingsystem/fetch_books_by_latest/',
          json: {"no_of_books": 10});
  ...
  Future<void> fetchNearByBooks() async {
    try {
      var response = await Requests.post(
          'http://yoururl/booksharingsystem/fetch_books_by_area/',
          json: {
  ...
  Future<void> fetchRecommendedBooks() async {
    ...
    try {
      var response = await Requests.post(
          'http://yoururl/booksharingsystem/fetch_books_by_genre/',
          json: {
              ...
              Padding(
                ...
                child: Row(
                  ...
                  children: <Widget>[
                    ...
                    InkWell(
                      onTap: () {
                        Navigator.push(context, MaterialPageRoute(builder: (context)=>BookViewScreen()));
                      },
                      child: Text('See All'),
                    ),
                  ],
                          ...
                          InkWell(
                            onTap: () {
                              Navigator.push(
                                  ...
                                  MaterialPageRoute(
                                      builder: (context) => BookViewScreen(
                                            book_id: nearByBookList[index].bookId,
                                          )));
                            },
                            child: Container(
                              height: 180,
                          ...
                          InkWell(
                            onTap: () {
                              Navigator.push(
                                  ...
                                  MaterialPageRoute(
                                      builder: (context) => BookViewScreen(
                                            book_id: recommendedList[index].bookId,
                                          )));
                            },
                            child: Container(
                              height: 180,
