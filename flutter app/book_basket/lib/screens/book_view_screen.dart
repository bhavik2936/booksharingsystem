...
class _BookViewScreenState extends State<BookViewScreen> {
  ...
  Future<String> fetchBookCode(String days) async {
    try {
      var response = await Requests.post(
        "http://yoururl/booksharingsystem/key_generation/",
  ...
  Future<void> verifyCode(String code) async {
    try {
      var response = await Requests.post(
          'http://yoururl/booksharingsystem/key_generation/verify_key.php',
  ...
  Future<void> fetchMyBooks() async {
    try {
      var response = await Requests.post(
          'http://yoururl/booksharingsystem/fetch_book_details/',
  ...
  Future<void> addComment() async {
    try {
      var response = await Requests.post(
          'http://yoururl/booksharingsystem/review/',
          json: {
            "book_id": book.bookId,
            "book_rating": rating,
            "review": comment
  ...
  Future<void> sendRequest() async {
    try {
      var response = await Requests.post(
          'http://yoururl/booksharingsystem/request/send_request.php',
  ...
  Future<void> fetchReviews() async {
    try {
      var response = await Requests.post(
          'http://yoururl/booksharingsystem/review/fetch_review.php',
          json: {"book_id": widget.book_id});
      response.raiseForStatus();
