...
class _MyRequestScreenState extends State<MyRequestScreen> {
  ...
  Future<void> fetchRequest() async {
    try {
      var response = await Requests.post(
        'http://yoururl/booksharingsystem/request/display_request.php',
      );
  ...
  Future<void> acceptRequest(int index) async {
    try {
      var response = await Requests.post(
          'http://yoururl/booksharingsystem/request/accept_request.php',
  ...
  Future<void> deleteRequest(int index) async {
    try {
      var response = await Requests.post(
          'http://yoururl/booksharingsystem/request/delete_request.php',
          json: {"id": transactionIdList[index]});
      response.raiseForStatus();
